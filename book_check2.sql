...
CREATE TABLE `check2` (
  ...
  `emp_country` varchar(20) DEFAULT NULL
...
INSERT INTO `check2` VALUES ('ajay','brisbane','aus'),('varun','sydney','aus'),('vikram','londan','uk'),('deva','ny','usa');
...
-- Dump completed on 2023-07-05 11:43:36
